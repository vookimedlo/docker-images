...
docker buildx build --build-arg GIT_COMMIT=$(git rev-parse -q --verify HEAD) --build-arg BUILD_DATE=$(date -u +"%Y-%m-%dT%H:%M:%SZ") --progress plain --push --platform linux/amd64,linux/arm64  -t ghcr.io/vookimedlo/fedora-gcc:gcc_38                           gcc/fedora/38
...
docker buildx build --build-arg GIT_COMMIT=$(git rev-parse -q --verify HEAD) --build-arg BUILD_DATE=$(date -u +"%Y-%m-%dT%H:%M:%SZ") --progress plain --push --platform linux/amd64,linux/arm64  -t ghcr.io/vookimedlo/fedora-clang:clang_38                       clang/fedora/38
...
docker buildx build --build-arg GIT_COMMIT=$(git rev-parse -q --verify HEAD) --build-arg BUILD_DATE=$(date -u +"%Y-%m-%dT%H:%M:%SZ") --progress plain --push --platform linux/amd64,linux/arm64  -t ghcr.io/vookimedlo/fedora-qt:qt6_latestDistroOfficial_clang_38       qt/fedora/38/latestDistroOfficial/clang
docker buildx build --build-arg GIT_COMMIT=$(git rev-parse -q --verify HEAD) --build-arg BUILD_DATE=$(date -u +"%Y-%m-%dT%H:%M:%SZ") --progress plain --push --platform linux/amd64,linux/arm64  -t ghcr.io/vookimedlo/fedora-qt:qt6_latestDistroOfficial_gcc_38         qt/fedora/38/latestDistroOfficial/gcc
